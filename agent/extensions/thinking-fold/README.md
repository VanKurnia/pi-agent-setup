...
reasoning trace. Behavior is tunable in `/thinking-fold-settings` (fold
depth, while/after-thinking strategies).
...
Run `/thinking-fold-settings` to configure the extension. It exposes three
