...
export default function registerSubagent(pi: ExtensionAPI) {
                ...
                const modelItems: SelectItem[] = [
                    {
                        ...
                        description: "Use agent file's default model",
                    },
                ];
    ...
    pi.registerTool({
        ...
        promptGuidelines: [
            ...
            "Single fact lookup on the web? Call route_web_search directly. Need 3+ searches, source comparison, or synthesis? Delegate to researcher.",
