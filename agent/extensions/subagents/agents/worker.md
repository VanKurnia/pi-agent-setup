...
tools: read, write, edit, resolve_pi_url, safe_bash, ffgrep, fffind, recall, ask_user_question, git_status, git_diff_unstaged, git_diff_staged, git_diff, git_add, git_commit, git_reset, git_log, git_create_branch, git_checkout, git_show, git_branch, query_sqlite, query_mysql
model: $WORKER_MODEL
---
