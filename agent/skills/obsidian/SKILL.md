...
name: obsidian
description: >
  Consolidated: vault navigation protocol, OFM syntax reference, writing conventions,
  and link qualification rules. Use when reading, writing, editing, or auditing notes
  in the Obsidian vault, or when working with wikilinks, embeds, callouts, properties,
  or cross-project link disambiguation.
---

# Obsidian Vault — Master Skill
...
```
Reading vault → navigator.md
Writing note  → writer.md → styles.md
Linking      → link-rules.md
```

Read the relevant reference doc in full before starting the task.
